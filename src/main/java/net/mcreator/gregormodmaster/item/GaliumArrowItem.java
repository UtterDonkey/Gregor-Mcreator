...
public class GaliumArrowItem extends GregormodmasterElements.ModElement {
	@ObjectHolder("gregormodmaster:galiumarrow")
	public static final Item block = null;
	public GaliumArrowItem(GregormodmasterElements instance) {
		super(instance, 25);
	}
