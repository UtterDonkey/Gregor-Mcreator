...
import net.mcreator.gregormodmaster.procedures.FollowWebProcedure;
import net.mcreator.gregormodmaster.GregormodmasterElements;

@GregormodmasterElements.ModElement.Tag
public class WebShooterItem extends GregormodmasterElements.ModElement {
	@ObjectHolder("gregormodmaster:webshooter")
	public static final Item block = null;
	@ObjectHolder("gregormodmaster:entitybulletwebshooter")
	public static final EntityType arrow = null;
	public WebShooterItem(GregormodmasterElements instance) {
		super(instance, 30);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletwebshooter").setRegistryName("entitybulletwebshooter"));
	}
		...
		public void onPlayerStoppedUsing(ItemStack itemstack, World world, LivingEntity entityLiving, int timeLeft) {
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				for (int i = 0; i < entity.inventory.mainInventory.size(); i++) {
					...
					if (stack != null && stack.getItem() == new ItemStack(WebItem.block, (int) (1)).getItem()) {
						slotID = i;
						break;
					}
				}
				if (entity.abilities.isCreativeMode || EnchantmentHelper.getEnchantmentLevel(Enchantments.INFINITY, itemstack) > 0 || slotID != -1) {
					...
					if (entity.abilities.isCreativeMode) {
						...
						if (new ItemStack(WebItem.block, (int) (1)).isDamageable()) {
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(WebItem.block, (int) (1));
		}
		...
		public void tick() {
			...
			Entity entity = this.getShooter();
			{
				...
				FollowWebProcedure.executeProcedure($_dependencies);
			}
			if (this.inGround) {
				this.remove();
			}
