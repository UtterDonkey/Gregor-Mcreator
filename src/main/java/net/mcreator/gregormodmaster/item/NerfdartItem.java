...
public class NerfdartItem extends GregormodmasterElements.ModElement {
	@ObjectHolder("gregormodmaster:nerfdart")
	public static final Item block = null;
	public NerfdartItem(GregormodmasterElements instance) {
		super(instance, 2);
	}
